...
export default function DossierDetail() {
  ...
  const initialDossier = location.state?.dossier || null;

  // Seed from navigation state if available (no skeleton), else fetch
  ...
  useEffect(() => {
    ...
    const run = async () => {
      if (initialDossier) {
        // Use preloaded info immediately, then refresh in background
